...
export default function CalendarPage() {
    const { data, loading, setData, page, setPage, limit, setLimit, total, setTotal, setFilters } = useDataFetcher("admin/calendar", false);
    const columns = [
          ...
          <div>
              <div className={"grid grid-cols-2 gap-5 items-center my-2 bg-bgSecondary w-full py-2 px-2"}>
                  <Link href={"/dashboard/configure/duties"}>
                      <Button variant="outlined">Configure Duty</Button>
                  </Link>
