...
const MultiStepForm = () => {
    ...
    const onSubmit = async (data) => {
        if (submit) {
            await handleRequestSubmit(data, setLoading, "employee/public/register", false, "Sending...", false, "POST");
        } else {
            setSubmit(true);
        }
    };
                            ...
                            <Controller
                                  ...
                                  render={({field}) => (
                                        <FormControl fullWidth margin="normal">
                                            ...
                                            {errors.zone &&
                                                  <Typography color="error">{errors.zone.message}</Typography>}
                                        </FormControl>
                                  )}
                            />
                            <Controller
                                  ...
                                  <Controller
                                        ...
                                        render={({field}) => (
                                              <FormControl fullWidth margin="normal">
                                                  ...
                                                  {errors.dutyId &&
                                                        <Typography color="error">{errors.dutyId.message}</Typography>}
                                              </FormControl>
                                        )}
                                  />
                            )}
